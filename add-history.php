...
<div class="container-fluid">
    ...
    <form id="addDefectForm">
        <input type="number" name="subjectId" id="subjectId" value="<?php echo $subjectId ?>" hidden>
        <div class="row">
            <div class="col-12 col-sm-3 px-3">
                <div class="form-group">
                    <label for="date_of_entry">Date of Entry</label>
                    <input type="date" class="form-control" name="date_of_entry" id="date_of_entry" required>
                </div>
            </div>
            <div class="col-12 col-sm-3 px-3">
                <div class="form-group">
                    <label for="date_of_clearance">Date of Clearance</label>
                    <input type="date" class="form-control" name="date_of_clearance" id="date_of_clearance" required>
                </div>
            </div>
            <div class="col-12 col-sm-3 px-3">
                <div class="form-group">
                    <label for="engine_no">Engine No</label>
                    <input type="text" class="form-control" name="engine_no" id="engine_no" required>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 px-3">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="rectification_work" id="rectification_work" rows="4" cols="50"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
...
<script>
    function submitForm(event) {
        ...
        var formData = new FormData(document.getElementById("addDefectForm"));
        ...
        xhr.open("POST", "addHistoryProcess.php", true);
        xhr.send(formData);
    }
</script>
</body>
